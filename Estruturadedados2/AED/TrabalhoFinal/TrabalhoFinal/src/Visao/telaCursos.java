...
public class telaCursos extends javax.swing.JFrame {
    ...
    public telaCursos(TreeSet<Curso> cursos) {
        initComponents();
        System.out.println("Construtor telaCursos recebeu: " + cursos.size() + " cursos");
        this.Cursos = cursos; 
            //-----------------------       
            //Cursos.add(new Curso(999, "Java Programming"));
            //Cursos.add(new Curso(919, "Python Development"));
            //Cursos.add(new Curso(929, "Web Development"));
            //-----------------------
        formatarID();
        listagem(cursos);
    }
    ...
    try{
            ...
            formatter.install(jFormattedTextID);
            jFormattedTextID.addFocusListener(new java.awt.event.FocusAdapter() {
            @Override
            public void focusGained(java.awt.event.FocusEvent evt) {
                jFormattedTextID.setCaretPosition(0); 
            }
        });
        } catch (Exception e) {
...
private void listagem(TreeSet<Curso> cursos) {
    try {
        ...
        System.out.println("Iniciando listagem dos cursos");
        // Direct iteration over the received collection
        for (Curso curso : cursos) {
            System.out.println("Adicionando curso: " + curso.getIdCurso() + " - " + curso.getdCurso());
            model.addRow(new Object[]{
                curso.getIdCurso(),
                curso.getdCurso()
            });
        }
        System.out.println("Finalizada a listagem dos cursos");
    ...
    private void initComponents() {
        ...
        jFormattedTextID = new javax.swing.JFormattedTextField();
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jFormattedTextID, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
    ...
    private void jIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jIncluirActionPerformed
        // TODO add your handling code here:
            try {
        int id = Integer.parseInt(jFormattedTextID.getText());
        ...
        dadosCurso.atualizarArquivo(this.Cursos);
        
        // Atualiza tabela
        listagem(this.Cursos);
        
        // Limpa campos
        jFormattedTextID.setText("");
    ...
    private void jAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jAlterarActionPerformed
        ...
        // Remove curso antigo e adiciona atualizado
        Curso cursoAtualizado = new Curso(id, descricao);
        this.Cursos.removeIf(c -> c.getIdCurso() == id);
        this.Cursos.add(cursoAtualizado);
...
public void run() {
        ...
        try {
            ...
            new telaCursos(cursos).setVisible(true);
        } catch (Exception e) {
    ...
    private javax.swing.JFormattedTextField jFormattedTextID;
