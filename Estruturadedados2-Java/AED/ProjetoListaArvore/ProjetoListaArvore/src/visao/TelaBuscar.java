...
public class TelaBuscar extends javax.swing.JDialog {
    ...
    private void ComboBox_BuscaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ComboBox_BuscaActionPerformed
        ...
        try {
        tipoBusca = ComboBox_Busca.getSelectedItem().toString();
        ...
        if (tipoBusca.equals("MATRICULA")) {
            ...
            FormattedTextFieldNomeMatricula.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(matriculaFormatter));
            FormattedTextFieldNomeMatricula.setText("");
