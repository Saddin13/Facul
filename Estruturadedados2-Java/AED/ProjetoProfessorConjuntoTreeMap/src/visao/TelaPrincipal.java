...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private TreeMap<Integer, Professor> professores = new TreeMap<>();
    ...
    private void listagem(TreeMap<Integer, Professor> professores) {
        try {
  ...
  private void jButtonIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonIncluirActionPerformed
    try {
        ...
        professores.put(matricula, novoProfessor);
  ...
  private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
    ...
    TreeMap<Integer, Professor> professoresOrdenados;
    
    if (ordem.equals("Ordem Alfabetica")) {
        professoresOrdenados = new TreeMap<>((k1, k2) -> 
            professores.get(k1).getNome().compareToIgnoreCase(professores.get(k2).getNome()));
    } else {
        professoresOrdenados = new TreeMap<>();
    }
    
    professoresOrdenados.putAll(professores);
